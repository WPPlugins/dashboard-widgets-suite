...
function dashboard_widgets_suite_register_settings() {
	...
	add_settings_field('widget_control_view',  __('View Role',         'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_select',   'dws_options_general', 'settings_general', array('id' => 'widget_control_view',  'section' => 'general', 'label' => esc_html__('User role required to view the Control Panel', 'dashboard-widgets-suite')));
	...
	add_settings_field('widget_notes_edit',       __('Edit Role',       'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_select',   'dws_options_notes_user', 'settings_notes_user', array('id' => 'widget_notes_edit',       'section' => 'notes_user', 'label' => esc_html__('User role required to add/edit/delete notes', 'dashboard-widgets-suite')));
	add_settings_field('widget_notes_view',       __('View Role',       'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_select',   'dws_options_notes_user', 'settings_notes_user', array('id' => 'widget_notes_view',       'section' => 'notes_user', 'label' => esc_html__('Default role to view notes (can be overridden when adding new notes)', 'dashboard-widgets-suite')));
	...
	add_settings_field('widget_feed_box_view',    __('View Role',       'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_select',   'dws_options_feed_box', 'settings_feed_box', array('id' => 'widget_feed_box_view',    'section' => 'feed_box', 'label' => esc_html__('User role required to view the Feed Box', 'dashboard-widgets-suite')));
	...
	add_settings_field('widget_social_box_view',   __('View Role',       'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_select',   'dws_options_social_box', 'settings_social_box', array('id' => 'widget_social_box_view',   'section' => 'social_box', 'label' => esc_html__('User role required to view the Social Box', 'dashboard-widgets-suite')));
	...
	add_settings_field('widget_social_box_goog1',  __('Google+',         'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_text',     'dws_options_social_box', 'settings_social_box', array('id' => 'widget_social_box_goog1',  'section' => 'social_box', 'label' => esc_html__('', 'dashboard-widgets-suite')));
	...
	add_settings_field('widget_social_box_eml1',   __('Email',           'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_text',     'dws_options_social_box', 'settings_social_box', array('id' => 'widget_social_box_eml1',   'section' => 'social_box', 'label' => esc_html__('', 'dashboard-widgets-suite')));
	...
	add_settings_field('widget_list_box_view', __('View Role',     'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_select',   'dws_options_list_box', 'settings_list_box', array('id' => 'widget_list_box_view', 'section' => 'list_box', 'label' => esc_html__('User role required to view the List Box', 'dashboard-widgets-suite')));
	...
	add_settings_field('widget_widget_box_view',    __('View Role',     'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_select',   'dws_options_widget_box', 'settings_widget_box', array('id' => 'widget_widget_box_view',    'section' => 'widget_box', 'label' => esc_html__('User role required to view the Widget Box', 'dashboard-widgets-suite')));
	...
	add_settings_field('widget_system_info_view', __('View Role',     'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_select',   'dws_options_system_info', 'settings_system_info', array('id' => 'widget_system_info_view', 'section' => 'system_info', 'label' => esc_html__('User role required to view System Info', 'dashboard-widgets-suite')));
	...
	add_settings_field('widget_log_debug_view',   __('View Role',      'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_select',   'dws_options_log_debug', 'settings_log_debug', array('id' => 'widget_log_debug_view',   'section' => 'log_debug', 'label' => esc_html__('User role required to view the Debug Log', 'dashboard-widgets-suite')));
	...
	add_settings_field('widget_log_error_view',   __('View Role',      'dashboard-widgets-suite'), 'dashboard_widgets_suite_callback_select',   'dws_options_log_error', 'settings_log_error', array('id' => 'widget_log_error_view',   'section' => 'log_error', 'label' => esc_html__('User role required to view the Error Log', 'dashboard-widgets-suite')));
